  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{!! route('subcategories.index') !!}"><i class="fa fa-list mr-2"></i>{{trans('lang.category_table')}}</a>
        </li>
        @endcan
        @can('subcategories.create')
        <li class="nav-item">
          <a class="nav-link" href="{!! route('subcategories.create') !!}"><i class="fa fa-plus mr-2"></i>sss</a>
        </li>
        @endcan
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-pencil mr-2"></i>111</a>
        </li>
      </ul>
    </div>
    <div class="card-body">
