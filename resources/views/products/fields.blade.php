...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <!-- Category Id Field -->
    <div class="form-group row ">
        {!! Form::label('category_id', trans("lang.product_category_id"),['class' => 'col-3 control-label text-right','id'=>'category_id']) !!}
        <div class="col-9">
    ...
    <div class="form-group row ">
        {!! Form::label('subcategory_id', 'subcategory',['class' => 'col-3 control-label text-right','id'=>'subcategory_id']) !!}
        <div class="col-9">
            {!! Form::select('subcategory_id', $subcategory, null, ['class' => 'select2 form-control']) !!}
            <div class="form-text text-muted">{{ trans("lang.product_category_id_help") }}</div>
        </div>
    </div>
    <div class="form-group row ">
        {!! Form::label('childcategory_id', 'childcategory',['class' => 'col-3 control-label text-right','id'=>'childcategory_id']) !!}
        <div class="col-9">
            {!! Form::select('childcategory_id', $childcategory, null, ['class' => 'select2 form-control']) !!}
            <div class="form-text text-muted">{{ trans("lang.product_category_id_help") }}</div>
        </div>
    </div>
