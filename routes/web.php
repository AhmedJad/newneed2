...
Route::middleware('auth')->group(function () {
	...
	Route::post('subcategories/remove-media', 'SubCategoryController@removeMedia'); 
	Route::get('category/{id}/subcategory','SubCategoryController@show')->name('show-sub');
	Route::get('subcategory/{id}/childcategory','ChildcategoryController@showChild')->name('show-child');
    Route::resource('subcategories', 'SubCategoryController')->except(['show']);
    Route::resource('Childcategory', 'ChildcategoryController')->except(['showChild']);
