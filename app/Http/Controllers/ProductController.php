...
class ProductController extends Controller
{
    ...
    public function __construct(ProductRepository $productRepo, CustomFieldRepository $customFieldRepo, UploadRepository $uploadRepo
        ...
        , CategoryRepository $categoryRepo,SubCategoryRepository $SubcategoryRepository,ChildCategoryRepository $childcategoryRepository)
    {
        parent::__construct();
    ...
    public function create()
    {
        ...
        $childcategory=$this->childcategoryRepository->pluck('name', 'id');
